...
var S = {
  init: async function () {
    ...
    if (i !== -1) {
      ...
      // #rectangle|
      // S.UI.simulate('|#countdown 3||2021再见！||2022||新年快乐|');
      S.UI.simulate('|#countdown 3||新年快乐|');
    }
  ...
  function performAction(value) {
    ...
    timedAction(function (index) {
      ...
      if(sequence.length==1){
        localStorage.setItem("countDownFlag", 1);
      }
      if(sequence.length == 2){
        // console.log("S.ShapeBuilder.fit(3)----")
        S.ShapeBuilder.fit(5);
      }
      switch (action) {
        case 'countdown':
...
// console.log(gap);
  ...
  function setFontSize(s) {
    ...
    // console.log(obj.w/1920, "obj.w/1920----",s)
