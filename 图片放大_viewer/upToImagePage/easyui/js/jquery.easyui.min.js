...
if(bb.first){
bb.first.linkbutton({disabled:((!_c0.total)||_c0.pageNumber==0)});
}
if(bb.prev){
bb.prev.linkbutton({disabled:((!_c0.total)||_c0.pageNumber==0)});
}
if(bb.next){
...
if(_72c.total!=data.total){
    _72b.pagination("refresh", { pageNumber: opts.pageNumber || _54b.pageNumber, total: data.total });
