...
DigitRoll.prototype={
        ...
        Array.prototype.forEach.call(this.container.querySelectorAll('.num'), function (item,i) {
            ...
            if (currentNum==goalNum) { //数字没变 不处理
                ...
                for (var j=currentNum; j<goalNum+1; j++) {
                    gapStr+='<div style="height: 100%">'+j+'</div>'
                }
    ...
    setWidth:function (n) {
        ...
        var str='';
        for (var i=0; i<n; i++) {
            str+='<div class="num" style="float:left;height:'+this.rollHeight+'px;line-height:'+this.rollHeight+'px"><div style="height: 100%">0</div></div>';
        }
