! function (a, b) {
    "undefined" == typeof a.HTMLVideoElement && (b.createElement("video"), b.createElement("audio"), b.createElement(
            "track")),
        function (a, b) {
            "use strict";
            ...
            var H = function (a) {
                ...
                K = {
                    ToInteger: function (a) {
                        var b = +a;
                        return J(b) ? b = 0 : 0 !== b && b !== 1 / 0 && b !== -(1 / 0) && (b = (b > 0 || -1) *
                            Math.floor(Math.abs(b))), b
                    },
            ...
            H(g, {
                bind: function (a) {
                    var c = this;
                    if (!b(c)) throw new TypeError("Function.prototype.bind called on incompatible " +
                        c);
                    ...
                    return d = Function("binder", "return function (" + i.join(",") +
                        "){ return binder.apply(this, arguments); }")(g), c.prototype && (L.prototype =
                        c.prototype, d.prototype = new L, L.prototype = null), d
                }
            });
            ...
            H(d, {
                forEach: function (a) {
                    ...
                    if (arguments.length > 1 && (c = arguments[1]), !b(a)) throw new TypeError(
                        "Array.prototype.forEach callback must be a function");
                    for (; ++f < g;) f in e && ("undefined" == typeof c ? a(e[f], f, d) : a.call(c, e[f],
                        f, d))
                }
            }, !W(d.forEach)), H(d, {
                map: function (a) {
                    var d, e = K.ToObject(this),
                        ...
                        h = c(g);
                    if (arguments.length > 1 && (d = arguments[1]), !b(a)) throw new TypeError(
                        "Array.prototype.map callback must be a function");
                    for (var i = 0; g > i; i++) i in f && ("undefined" == typeof d ? h[i] = a(f[i], i,
                        e) : h[i] = a.call(d, f[i], i, e));
                    return h
                }
            }, !W(d.map)), H(d, {
                filter: function (a) {
                    ...
                    for (var i = 0; g > i; i++) i in f && (c = f[i], ("undefined" == typeof d ? a(c, i,
                        e) : a.call(d, c, i, e)) && R(h, c));
                    return h
                }
            }, !W(d.filter)), H(d, {
                every: function (a) {
            ...
            H(d, {
                indexOf: function (a) {
                    ...
                    if (0 === c) return -1;
                    var d = 0;
                    for (arguments.length > 1 && (d = K.ToInteger(arguments[1])), d = d >= 0 ? d : r(0,
                            c + d); c > d; d++)
            ...
            H(d, {
                lastIndexOf: function (a) {
                    ...
                    if (0 === c) return -1;
                    var d = c - 1;
                    for (arguments.length > 1 && (d = s(d, K.ToInteger(arguments[1]))), d = d >= 0 ? d :
                        c - Math.abs(d); d >= 0; d--)
            ...
            H(d, {
                splice: function (a, b) {
                    ...
                    var c = arguments;
                    return this.length = r(K.ToInteger(this.length), 0), arguments.length > 0 &&
                        "number" != typeof b && (c = l.call(arguments), c.length < 2 ? R(c, this.length -
                            a) : c[1] = K.ToInteger(b)), m.apply(this, c)
                }
            }, !aa);
            var ba = function () {
                    var a = new c(1e5);
            ...
            H(d, {
                splice: function (a, b) {
                    for (var c, d = K.ToObject(this), e = [], f = K.ToUint32(d.length), g = K.ToInteger(
                            a), i = 0 > g ? r(f + g, 0) : s(g, f), j = s(r(K.ToInteger(b), 0), f -
                            i), k = 0; j > k;) c = h(i + k), M(d, c) && (e[k] = d[c]), k += 1;
                    var m, n = l.call(arguments, 2),
                        o = n.length;
                    if (j > o) {
                        for (k = i; f - j > k;) c = h(k + j), m = h(k + o), M(d, c) ? d[m] = d[c] :
                            delete d[m], k += 1;
                        for (k = f; k > f - j + o;) delete d[k - 1], k -= 1
                    } else if (o > j)
                        for (k = f - j; k > i;) c = h(k + j - 1), m = h(k + o - 1), M(d, c) ? d[m] = d[
                            c] : delete d[m], k -= 1;
                    k = i;
            ...
            var fa = function (a) {
                    for (var b = K.ToObject(this), c = K.ToUint32(b.length), d = 0; d < arguments.length;) b[c + d] =
                        arguments[d], d += 1;
            ...
            var ia = !{
                ...
                pa = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf",
                ...
                sa = function (a) {
                    return null !== a && "object" == typeof a && "number" == typeof a.length && a.length >= 0 && !S(
                        a) && b(a.callee)
                },
            ...
            H(Date.prototype, {
                toISOString: function () {
                    ...
                    for (d = this.getUTCFullYear(), e = this.getUTCMonth(), d += Math.floor(e / 12), e =
                        (e % 12 + 12) % 12, a = [e + 1, this.getUTCDate(), this.getUTCHours(), this.getUTCMinutes(),
                            this.getUTCSeconds()], d = (0 > d ? "-" : d > 9999 ? "+" : "") + O("00000" +
                            Math.abs(d), d >= 0 && 9999 >= d ? -4 : -6), b = a.length; b--;) c = a[b],
                        10 > c && (a[b] = "0" + c);
                    return d + "-" + l.call(a, 0, 2).join("-") + "T" + l.call(a, 2).join(":") + "." + O(
                        "000" + this.getUTCMilliseconds(), -3) + "Z"
                }
            }, za || Aa);
            var Ba = function () {
                try {
                    return Date.prototype.toJSON && null === new Date(NaN).toJSON() && -1 !== new Date(xa).toJSON()
                        .indexOf(ya) && Date.prototype.toJSON.call({
                            toISOString: function () {
                                return !0
                            }
                        })
            ...
            var Ca = 1e15 === Date.parse("+033658-09-27T01:46:40.000Z"),
                Da = !isNaN(Date.parse("2012-04-04T24:00:00.500Z")) || !isNaN(Date.parse("2012-11-31T23:59:59.000Z")) ||
                ...
                Date = function (a) {
                    var b = function (c, d, e, f, g, i, j) {
                            ...
                            if (this instanceof a) {
                                ...
                                k = 1 === l && h(c) === c ? new a(b.parse(c)) : l >= 7 ? new a(c, d, e, f, g, m,
                                        n) : l >= 6 ? new a(c, d, e, f, g, m) : l >= 5 ? new a(c, d, e, f, g) :
                                    l >= 4 ? new a(c, d, e, f) : l >= 3 ? new a(c, d, e) : l >= 2 ? new a(c, d) :
                                    l >= 1 ? new a(c) : new a
                        ...
                        e = function (a, b) {
                            var c = b > 1 ? 1 : 0;
                            return d[b] + Math.floor((a - 1969 + c) / 4) - Math.floor((a - 1901 + c) / 100) +
                                Math.floor((a - 1601 + c) / 400) + 365 * (a - 1970)
                        },
                        f = function (b) {
                            var c = 0,
                                d = b;
                    ...
                    var i = function (b) {
                        ...
                        if (d) {
                            var g, h = j(d[1]),
                                ...
                                s = j(d[11] || 0),
                                t = m > 0 || n > 0 || o > 0;
                            return (t ? 24 : 25) > l && 60 > m && 60 > n && 1e3 > o && i > -1 && 12 > i &&
                                24 > r && 60 > s && k > -1 && k < e(h, i + 1) - e(h, i) && (g = 60 * (24 *
                                        (e(h, i) + k) + l + r * q), g = 1e3 * (60 * (g + m + s * q) + n) +
                                    o, p && (g = f(g)), g >= -864e13 && 864e13 >= g) ? g : NaN
                        }
            ...
            var Ha = k.toFixed && ("0.000" !== 8e-5.toFixed(3) || "1" !== .9.toFixed(0) || "1.25" !== 1.255.toFixed(
                    2) || "1000000000000000128" !== 0xde0b6b3a7640080.toFixed(0)),
                Ia = {
                    base: 1e7,
                    size: 6,
                    data: [0, 0, 0, 0, 0, 0],
                    multiply: function (a, b) {
                        for (var c = -1, d = b; ++c < Ia.size;) d += a * Ia.data[c], Ia.data[c] = d % Ia.base,
                            d = Math.floor(d / Ia.base)
                    },
                    divide: function (a) {
                        for (var b = Ia.size, c = 0; --b >= 0;) c += Ia.data[b], Ia.data[b] = Math.floor(c / a),
                            c = c % a * Ia.base
                    },
                ...
                Ja = function (a) {
                    var b, c, d, e, f, g, i, k;
                    if (b = j(a), b = J(b) ? 0 : Math.floor(b), 0 > b || b > 20) throw new RangeError(
                    ...
                    if (d = "", 0 > c && (d = "-", c = -c), e = "0", c > 1e-21)
                        if (f = Ia.log(c * Ia.pow(2, 69, 1)) - 69, g = 0 > f ? c * Ia.pow(2, -f, 1) : c / Ia.pow(2,
                                f, 1), g *= 4503599627370496, f = 52 - f, f > 0) {
                        ...
                        } else Ia.multiply(0, g), Ia.multiply(1 << -f, 0), e = Ia.numToString() + O(
                            "0.00000000000000000000", 2, 2 + b);
                    return b > 0 ? (k = e.length, e = b >= k ? d + O("0.0000000000000000000", 0, b - k + 2) + e : d +
                        O(e, 0, k - b) + "." + O(e, k - b)) : e = d + e, e
                };
            H(k, {
                toFixed: Ja
            }, Ha);
            ...
            H(k, {
                ...
                }, Ka), 2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst"
                .split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || ".".split(
                    /()()/).length > 1 ? ! function () {
                    ...
                    i.split = function (c, d) {
                        ...
                        var f, g, h, i, j = [],
                            k = (c.ignoreCase ? "i" : "") + (c.multiline ? "m" : "") + (c.unicode ? "u" : "") +
                            (c.sticky ? "y" : ""),
                            m = 0,
                            o = new RegExp(c.source, k + "g");
                        e += "", a || (f = new RegExp("^" + o.source + "$(?!\\s)", k));
                        var p = "undefined" == typeof d ? b : K.ToUint32(d);
                        for (g = o.exec(e); g && (h = g.index + g[0].length, !(h > m && (R(j, O(e, m, g.index)),
                                !a && g.length > 1 && g[0].replace(f, function () {
                                    for (var a = 1; a < arguments.length - 2; a++) "undefined" ==
                                        typeof arguments[a] && (g[a] = void 0)
                                }), g.length > 1 && g.index < e.length && n.apply(j, l.call(g, 1)), i =
                                g[0].length, m = h, j.length >= p)));) o.lastIndex === g.index && o.lastIndex++,
                            g = o.exec(e);
                        return m === e.length ? (i || !o.test("")) && R(j, "") : R(j, O(e, m)), j.length > p ?
                            O(j, 0, p) : j
                    }
            ...
            Na || (i.replace = function (a, c) {
                ...
                if (d && e) {
                    var f = function (b) {
                        ...
                        a.lastIndex = 0;
                        var f = a.exec(b) || [];
                        return a.lastIndex = e, R(f, arguments[d - 2], arguments[d - 1]), c.apply(this,
                            f)
                    };
            ...
            H(i, {
                lastIndexOf: function (a) {
                    if ("undefined" == typeof this || null === this) throw new TypeError(
                        "can't convert " + this + " to object");
                    for (var b = h(this), c = h(a), d = arguments.length > 1 ? j(arguments[1]) : NaN, e =
                            J(d) ? 1 / 0 : K.ToInteger(d), f = s(r(e, 0), b.length), g = c.length, i =
                            f + g; i > 0;) {
                        i = r(0, i - g);
                        var k = Q(O(b, i, f + g), c);
                        if (-1 !== k) return i + k
            ...
            if (H(i, {
                ...
                }, 1 !== i.lastIndexOf.length), (8 !== parseInt(Qa + "08") || 22 !== parseInt(Qa + "0x16")) && (
                    parseInt = function (a) {
                        var b = /^[\-+]?0[xX]/;
                        return function (c, d) {
                            var e = h(c).trim(),
                ...
                var Ya = (Error.prototype.toString, function () {
                    if ("undefined" == typeof this || null === this) throw new TypeError("can't convert " +
                        this + " to object");
                    var a = this.name;
                    "undefined" == typeof a ? a = "Error" : "string" != typeof a && (a = h(a));
                    var b = this.message;
                    return "undefined" == typeof b ? b = "" : "string" != typeof b && (b = h(b)), a ? b ? a +
                        ": " + b : a : b
                });
        ...
        function (a, b) {
            ...
            k && (a = f.bind(g.__defineGetter__), c = f.bind(g.__defineSetter__), d = f.bind(g.__lookupGetter__), e =
                f.bind(g.__lookupSetter__)), Object.getPrototypeOf || (Object.getPrototypeOf = function (a) {
                var b = a.__proto__;
                return b || null === b ? b : "[object Function]" === j(a.constructor) ? a.constructor.prototype :
                    a instanceof Object ? g : null
            });
            var l = function (a) {
                try {
            ...
            if (Object.getOwnPropertyNames || (Object.getOwnPropertyNames = function (a) {
                ...
                var q, r = !({
                    ...
                    t = function () {
                        var a, b;
                        return b = new ActiveXObject("htmlfile"), b.write("<script></script>"), b.close(), a = b.parentWindow
                            .Object.prototype, b = null, a
                    },
                    u = function () {
                        var a, c = b.createElement("iframe"),
                            d = b.body || b.documentElement;
                        return c.style.display = "none", d.appendChild(c), c.src = "javascript:", a = c.contentWindow
                            .Object.prototype, d.removeChild(c), c = null, a
                    };
                q = r || "undefined" == typeof b ? function () {
                    ...
                    var a = s() ? t() : u();
                    delete a.constructor, delete a.hasOwnProperty, delete a.propertyIsEnumerable, delete a.isPrototypeOf,
                        delete a.toLocaleString, delete a.toString, delete a.valueOf;
                    var b = function () {};
